...
<head>
	...
	<title>Aarjav Akshay Kothari</title>
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section class="slogan fade-down">
			<h1>I'll be here with my personal website soon.</h1>			
		</section>
		<!-- Slogan end here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="aarjav.kothari@gmail.com"; // Add your e-mail here
        	if($code!=$captcha){
        ...
        <div class="clearfix cnt-wrap">
          <div class="col-md-4 col-sm-4">
            ...
            <h4>Phone</h4>
            Mobile: (858) 766 8224<br /> <br/>
          </div>

          <div class="col-md-4 col-sm-4">      
            <i class="fa fa-envelope-o"></i>
            <h4>Email</h4>
            <p>aarjav.kothari@gmail.com<br />aakothar@ucsd.edu</p>
          </div>
          <!--<div class="col-md-4 col-sm-4">
